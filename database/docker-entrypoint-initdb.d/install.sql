...
create user varlamov with password 'varlamov';

create database varlamov owner varlamov;
...
grant select, insert, update, delete on public.post to varlamov;
grant select, usage on sequence public.post_id_seq to varlamov;
...
grant select, insert, update, delete on public.image to varlamov;
grant select, usage on sequence public.image_id_seq to varlamov;
